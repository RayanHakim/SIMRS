<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- Menu Khusus Apoteker & Admin --}}
                    @role('admin|apoteker')
                    <x-nav-link :href="route('apotek.index')" :active="request()->routeIs('apotek.*')">
                        {{ __('Apotek') }}
                    </x-nav-link>
                    @endrole
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- Responsive Links based on Roles --}}
            @role('admin|resepsionis')
            ...
            @role('dokter')
            <x-responsive-nav-link :href="route('pemeriksaan.index')" :active="request()->routeIs('pemeriksaan.index')">
                {{ __('Antrean Pasien') }}
            </x-responsive-nav-link>
            @endrole
        </div>
